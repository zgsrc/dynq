...
module.exports = function(schema, description) {
    ...
    this.delete = function(obj, cb) { 
        me.schema.connection.destroy(name, extractKey(obj), cb); 
    };
    
    this.deleteIf = function(obj, exp, cb) { 
        me.schema.connection.destroy(name, extractKey(obj), exp, cb); 
    };
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////
    this.query = function() { 
        return new Query(me.schema.connection, name, "query"); 
    };
    
    this.scan = function() { 
        return new Query(me.schema.connection, name, "scan"); 
    };
