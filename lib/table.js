...
module.exports = function(schema, description) {
    ...
    var me = this,
        ...
        extractKey = (obj) => { util.extract(key, obj); };
    ...
    this.insertAll = function(objs, cb) { 
        me.schema.connection.insert(name, key, objs, cb); 
    };
    
    this.upsert = function(obj, cb) {
        me.connection.upsert(name, key, obj, cb);
    };
    
    this.update = function(obj, cb) {
        me.connection.update(name, key, obj, cb);
    };
