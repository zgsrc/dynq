    ...
    if (obj == null) return obj;
        ...
        for (var k in obj) {
            if (obj[k] != null) {
                if (obj[k].S) obj[k] = obj[k].S;
                ...
                else if (obj[k].BOOL) obj[k] = obj[k].BOOL;
                    ...
                    console.debug("Unable to decode dynamo field " + JSON.stringify(obj[k]) + ".");
                }
            }
            else delete obj[k];
        }
    ...
    if (Object.isNumber(o)) return { N: o.toString() };
        ...
        if (o.length == 0) return null;
            ...
            return { L: o.map(function(o) { 
                return Object.isObject(o) ? { M: encode(o, saveEmpty, true) } : encode(o, saveEmpty);
            }) };
        }
    }
